...
if __name__ == "__main__":
    ...
    cv2.namedWindow("Corner result 1")
    cv2.createTrackbar("threshold", "Corner result 1", 625, 6000, nothing)
    while True:
        img_out_1 = img_1.copy()
        img_out_2 = img_2.copy()
        threshold = cv2.getTrackbarPos("threshold", "Corner result 1")
        ...
        cv2.imshow("Corner result 1", img_out_1)
        cv2.imshow("Corner result 2", img_out_2)
